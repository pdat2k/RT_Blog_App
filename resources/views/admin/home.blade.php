...
@section('content')
    <section class="section-admin">
        <div class="content">
            <h1 class="blogpost-title">User list</h1>
                        ...
                        <tr class="table-user-row {{ $user->id }}">
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center gap-3">
                                    ...
                                    <button class="btn btn-primary table-icon" type="button">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close detail-comment-boxs-button modalDelete" data-dismiss="modal"
                        aria-label="Close">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-danger table-delete-userbtn">{{ __('util.delete') }}</button>
                </div>
            </div>
        </div>
    </div>
